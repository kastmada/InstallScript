...
It is also optimized for Ubuntu 20.04 and multiple instances under NGINX.
...
```
sudo wget https://raw.githubusercontent.com/kastmada/InstallScript/14.0/odoo_install.sh
```
